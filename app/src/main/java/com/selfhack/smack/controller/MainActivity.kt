...
import com.selfhack.smack.adapters.MessageAdapter
        ...
        if (App.prefs.isloggedIn) {
            runOnUiThread {
                ...
                if (channelID.equals(selectedChannel?.id)) {
                    ...
                    val newMessage = Message(message, id, channelID, userName, userAvatar, userAvatarColor, timestamp)
